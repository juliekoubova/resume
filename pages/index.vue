<template>
  <div>
    <resume-cover />
    <div class="screen:max-w-5xl mx-auto px-6">
      <div class="flex">
        ...
        <div class="flex-shrink-0 w-1/4 pl-10 hidden md:block print:hidden">
          <resume-tech :tech="tech" class="mt-4" />
        </div>
      </div>
    </div>
  </div>
